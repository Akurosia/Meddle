...
public class UpdateWindow : Window
{
    ...
    [
        ...
        new()
        {
            Tag = "Updated default directory (and other improvements)",
            Date = "2026-07-10",
            Changes =
            [
                new WarningUpdateLine(" ! NOTE: Default export directory has been changed from Temp folder to your Documents folder"),
